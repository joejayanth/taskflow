      ...
      <Card className={cn(
        ...
        <CardHeader className="p-3 pb-1.5">
          <div className="flex items-start justify-between gap-2">
            <TaskDialog onSave={onTaskUpdate} onDelete={onTaskDelete} task={task} trigger={
              <CardTitle className="text-[21px] font-semibold leading-snug cursor-pointer hover:text-primary transition-colors flex-1 min-w-0 break-words">
                {task.title}
              </CardTitle>
            } />
            <Button
        ...
        <CardContent className="px-3 pb-3 pt-1 space-y-2">
          ...
          {descriptionSnippet && (
            <TaskDialog onSave={onTaskUpdate} onDelete={onTaskDelete} task={task} trigger={
              <p className="text-[18px] text-muted-foreground/70 leading-relaxed cursor-pointer line-clamp-2 break-all">
                {descriptionSnippet}
              </p>
            } />
          )}
          ...
          <div className="flex items-center justify-between text-[18px]">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <Badge
                ...
                className={cn(
                  "font-semibold py-0 px-1.5 h-[27px] text-[15px] uppercase tracking-wider rounded-md",
          ...
          {task.blocked && (
            <div className="flex items-center gap-1 text-destructive font-semibold text-[15px] uppercase tracking-wider">
